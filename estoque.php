...
<input type="text" id="input-serial" class="w-full px-4 py-3 rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-[#000000] dark:text-white" placeholder="SN123456789" required uppercase>
</div>
